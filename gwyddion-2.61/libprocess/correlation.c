/*
 *  $Id: correlation.c 24420 2021-10-24 11:17:25Z yeti-dn $
                                  ...
                                  gdouble fill_value)
{
    ...
    is_score = (method == GWY_CORR_SEARCH_COVARIANCE_SCORE || method == GWY_CORR_SEARCH_HEIGHT_DIFF_SCORE);
    ...
    if (is_score || method == GWY_CORR_SEARCH_HEIGHT_DIFF) {
