/*
 *  $Id: dataline.c 24757 2022-04-06 11:41:24Z yeti-dn $
 ...
 * gwy_data_line_get_real(data_line)/gwy_data_line_get_res(data_line).
 *
 ...
 * @result: A data line to put the result to.  May be one of @operand1,
 *          @operand2.
