/*
 *  $Id: stats.c 22839 2020-06-15 14:22:37Z yeti-dn $
 ...
 * See gwy_data_field_get_mean_square() for a similar function which does not
                                      ...
                                      gint height)
{
    ...
    if (!mask) {
        return gwy_data_field_area_get_rms_mask(dfield, NULL, GWY_MASK_IGNORE,
                                                col, row, width, height);
    }
 ...
 *
 * Unlike gwy_data_field_get_rms(), this function does <emphasis>not</emphasis>
                                  ...
                                  gdouble *to)
{
    ...
    gwy_data_field_area_get_min_max_mask(data_field, mask, masking,
                             ...
                             gdouble *to)
{
    ...
    gwy_data_field_get_min_max(data_field, &min, &max);
    compute_autorange(data_field->data, data_field->xres*data_field->yres,
                      min, max, &rmin, &rmax);
