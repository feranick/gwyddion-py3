/*
 *  $Id: filters.c 24518 2021-11-12 15:43:28Z yeti-dn $
 ...
 * @data_field: A data field to apply the filter to.
 * @xder: Data field where the x-derivarive is to be stored, or %NULL if you are only interested in the y-derivarive.
 * @yder: Data field where the y-derivarive is to be stored, or %NULL if you are only interested in the x-derivarive.
 *
 * Calculates x and y derivaties for an entire field.
 *
 * The derivatives are calculated as the simple symmetrical differences (in physical units, not pixel-wise), except at
