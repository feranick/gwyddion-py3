/*
 *  $Id: gwymodule-volume.h 20678 2017-12-18 18:26:55Z yeti-dn $
...
#ifndef __GWY_MODULE_VOLUME_H__
#define __GWY_MODULE_VOLUME_H__
...
typedef void (*GwyVolumeFunc)(GwyContainer *data,
                              GwyRunType run,
                              const gchar *name);
...
void         gwy_volume_func_foreach             (GFunc function,
                                                  gpointer user_data);
const gchar* gwy_volume_func_current             (void);

G_END_DECLS

#endif /* __GWY_MODULE_VOLUME_H__ */
