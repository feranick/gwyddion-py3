/*
 *  $Id: gwy3dview.c 24619 2022-02-25 15:33:15Z yeti-dn $
...
gwy_3d_view_update_labels(Gwy3DView *gwy3dview)
{
    ...
    format = gwy_3d_view_update_label(gwy3dview, "max", data_max, maximum, range/12.0, TRUE, format);
    format = gwy_3d_view_update_label(gwy3dview, "min", data_min, maximum, range/12.0, TRUE, format);
...
gwy_3d_draw_axes(Gwy3DView *widget, gint width, gint height)
{
    ...
    */
    ...
    if (widget->setup->labels_visible
        ...
        gwy_3d_util_project(Cx - (Ax-Bx)*0.1, Cy - (Ay-By)*0.1, data_max-data_min, mpM, vpM, &vx, &vy, &vz);
        ...
        gwy_3d_texture_text(widget, yfirst ? GWY_3D_VIEW_LABEL_Y : GWY_3D_VIEW_LABEL_X, sx, sy, sz, rotA,
                            size, GWY_3D_JUST_CENTER, GWY_3D_JUST_CENTER);

        gwy_3d_texture_text(widget, yfirst ? GWY_3D_VIEW_LABEL_X : GWY_3D_VIEW_LABEL_Y, tx, ty, tz, rotB,
                            size, GWY_3D_JUST_CENTER, GWY_3D_JUST_CENTER);

        gwy_3d_texture_text(widget, GWY_3D_VIEW_LABEL_MAX, vx, vy, vz, 0,
                            size, GWY_3D_JUST_LEFT_EDGE, GWY_3D_JUST_CENTER);

        gwy_3d_texture_text(widget, GWY_3D_VIEW_LABEL_MIN, ux, uy, uz, 0,
                            size, GWY_3D_JUST_LEFT_EDGE, GWY_3D_JUST_CENTER);
...
gwy_3d_draw_light_position(Gwy3DView *widget)
{
    ...
    glPushMatrix();
    plane_z = GWY_3D_Z_TRANSFORMATION*(data_mean - data_min)/(data_max  - data_min) + GWY_3D_Z_DISPLACEMENT;
