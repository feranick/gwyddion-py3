/*
 *  $Id: gwygraphexport.c 21292 2018-08-01 09:57:34Z yeti-dn $
 ...
 * @export_title: %TRUE to export graph title.  Currently unimplemented.
 * @export_axis: %TRUE to export graph axes.  Currently unimplemented.
 * @export_labels: %TRUE to export graph labels.  Currently unimplemented.
 *
 ...
 * @export_axis: %TRUE to export graph axes.  Currently unimplemented.
 * @export_labels: %TRUE to export graph labels.  Currently unimplemented.
 * @str: String to put the PostScript representation to, or %NULL to
 *          allocate a new string.
 *
 * Approximately renders a graph widget in PostScript.
 *
 * Returns: Either @string or a newly created #GString.
 **/
GString*
