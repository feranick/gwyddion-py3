/*
 *  $Id: createc.c 21783 2019-01-03 12:58:14Z yeti-dn $
                   ...
                   GError **error)
{
    ...
    xreal = xres * ti1; /* dacs */
    xreal *= 20.0/gwy_powi(2.0, dacbits) * ti2; /* voltage per dac */
    ...
    yreal = yres * ti1;
    yreal *= 20.0/gwy_powi(2.0, dacbits) * ti2;
    yreal *= Angstrom * td;
    if (!(yreal = fabs(yreal))) {
    ...
    q = 1.0; /* unity dac */
    q *= 20.0/gwy_powi(2.0, dacbits) * ti2; /* voltage per dac */
                 ...
                 gint bpp)
{
    if (bpp == 2)
        gwy_convert_raw_data(buffer, n, 1,
                             ...
                             data, gwy_powi(1.0/256.0, bpp), 0.0);
    else if (bpp == 4)
        gwy_convert_raw_data(buffer, n, 1,
