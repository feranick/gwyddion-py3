/*
 *  $Id: ellipse.c 24732 2022-03-23 20:01:21Z yeti-dn $
...
static gboolean gwy_layer_ellipse_button_released(GwyVectorLayer *layer,
                                                  GdkEventButton *event);
static gboolean gwy_layer_ellipse_key_pressed    (GwyVectorLayer *layer,
                                                  GdkEventKey *event);
...
gwy_layer_ellipse_class_init(GwyLayerEllipseClass *klass)
{
    ...
    vector_class->key_press = gwy_layer_ellipse_key_pressed;
...
static gboolean
gwy_layer_ellipse_key_pressed(GwyVectorLayer *layer,
                              GdkEventKey *event)
{
