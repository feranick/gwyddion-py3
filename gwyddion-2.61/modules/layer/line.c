/*
 *  $Id: line.c 24732 2022-03-23 20:01:21Z yeti-dn $
...
static gboolean   gwy_layer_line_button_released (GwyVectorLayer *layer,
                                                  GdkEventButton *event);
static gboolean   gwy_layer_line_key_pressed     (GwyVectorLayer *layer,
                                                  GdkEventKey *event);
...
gwy_layer_line_class_init(GwyLayerLineClass *klass)
{
    ...
    vector_class->key_press = gwy_layer_line_key_pressed;
                           ...
                           gint i)
{
    ...
    if (layer_line->thickness > 1) {
        gint xres, yres, xl0, yl0, xl1, yl1;
        gdouble xd, yd, h;
        ...
        h = hypot(xd, yd);
        xd *= layer_line->thickness/h *xreal/xres/2;
        yd *= layer_line->thickness/h *yreal/yres/2;
...
static gboolean
gwy_layer_line_key_pressed(GwyVectorLayer *layer,
                           GdkEventKey *event)
{
