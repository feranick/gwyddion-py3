/*
 *  $Id: point.c 23546 2021-04-20 14:43:33Z yeti-dn $
...
static gboolean   gwy_layer_point_button_released   (GwyVectorLayer *layer,
                                                     GdkEventButton *event);
static gboolean   gwy_layer_point_key_pressed       (GwyVectorLayer *layer,
                                                     GdkEventKey *event);
...
gwy_layer_point_class_init(GwyLayerPointClass *klass)
{
    ...
    vector_class->key_press = gwy_layer_point_key_pressed;
...
static gboolean
gwy_layer_point_key_pressed(GwyVectorLayer *layer,
                            GdkEventKey *event)
{
