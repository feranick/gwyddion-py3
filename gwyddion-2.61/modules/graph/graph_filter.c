/*
 *  $Id: graph_filter.c 24428 2021-10-26 15:41:27Z yeti-dn $
...
filter(GwyGraph *graph)
{
    ...
    for (i = 0; i < ncurves; i++) {
        ...
        gwy_graph_curve_model_set_data(cmodelnew, xdata, newydata, ndata);
        g_free(newydata);
...
static void
filter_do(const gdouble *yold, gdouble *y, gint n)
{
