/*
 *  $Id: graph_polylevel.c 24487 2021-11-07 21:05:57Z yeti-dn $
...
param_changed(ModuleGUI *gui, gint id)
{
    ...
    if (id < 0 || id == PARAM_CURVE || id == PARAM_OUTPUT_TYPE || id == PARAM_ALL || id == PARAM_ORDER) {
...
execute(ModuleArgs *args, GwyResults *results)
{
    ...
    param = gwy_math_fit_polynom(n, xdata + fitstart, ydata + fitstart, order, param);
